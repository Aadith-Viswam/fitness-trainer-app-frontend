...
const createprogress = async (workoutId, percentage) => {
  try {
    const res = await axios.post(`${apiUrl}/user/createprogress`, { workoutId, percentage }, {
      withCredentials: true
    });
    return res.data;
...
const getProgress = async () => {
  try {
    const res = await axios.get(`${apiUrl}/user/progress`, {
      withCredentials: true
    });
    return res.data;
  } catch (err) {
...
export { signupUser, loginUser, getUserData, logoutUser, ai, createprogress, getProgress };
